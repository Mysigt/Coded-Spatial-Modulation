function [phys_response,spatial_cons,signal_cons]=ref_const_joint(H_ch,tx,signal_size,b_m)
    ...
    mapped_ref=sm_mapper_joint(spatial_cons,signal_cons,tx,signal_size,b_m);
