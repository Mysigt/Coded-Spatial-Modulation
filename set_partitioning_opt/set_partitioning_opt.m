tx=4;       %transmitter antenna number
rx=4;       %receiver antenna number
fadingtype='Rician'; %fading type: 'Rician' or 'Rayleigh'
factor=3;   %Rician fading factor

H_ch=channel_matrix(tx,rx,fadingtype,factor);       %Initilize the channel response

antennas=['A'; 'B' ;'C'; 'D'];      %antenna names, should have same amount of elements as tx number
